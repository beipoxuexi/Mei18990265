...
import com.example.myapplication9_shop.fragment.TabFirstFragment;
import com.example.myapplication9_shop.fragment.TabSecondFragment;
import com.example.myapplication9_shop.fragment.TabThirdFragment;
import com.example.myapplication9_shop.util.DateUtil;
import com.example.myapplication9_shop.util.MenuUtil;
...
public class TabFragmentActivity extends AppCompatActivity {
    ...
    private void initSearchView(Menu menu) {
        ...
        // 创建搜索结果页面的组件名称对象
        ComponentName cn = new ComponentName(this, com.example.myapplication9_shop.SearchResultActivity.class);
