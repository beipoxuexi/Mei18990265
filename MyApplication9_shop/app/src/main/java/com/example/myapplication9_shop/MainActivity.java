...
import com.example.myapplication9_shop.bean.UserInfo;
import com.example.myapplication9_shop.database.UserDBHelper;
import com.example.myapplication9_shop.util.DateUtil;
import com.example.myapplication9_shop.util.ViewUtil;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, View.OnFocusChangeListener {
    ...
    private String[] typeArray = {"个人用户", "公司用户","18990265梅杰"};
    ...
    private class HideTextWatcher implements TextWatcher {
        ...
        public void afterTextChanged(Editable s) {
            ...
            if ((mStr.length() == 11 && mMaxLength == 11) ||
                ...
                ViewUtil.hideOneInputMethod(com.example.myapplication9_shop.MainActivity.this, mView);
            }
        }
    }
